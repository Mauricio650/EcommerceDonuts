...
export function UpdateForm ({ showModalUpdate, handleModalUpdate }) {
  ...
  return (
    <section role='modal' className={`${showModalUpdate.show ? 'flex' : 'hidden'} filter backdrop-blur-sm   absolute  top-0 z-1  w-full h-full justify-center items-start`}>
      ...
      <form
        ...
        }} className='bg-[#FD70A7] relative rounded-2xl gap-2 shadow-2xl flex flex-col justify-center mt-10 items-center py-5 w-[500px]' encType='multipart/form-data'
      >
