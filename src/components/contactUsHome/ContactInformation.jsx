  ...
  return (
    <div className='space-grotesk flex flex-col  justify-center p-2 bg-[#FFFFFF] rounded shadow-lg shadow-black/30'>
      <div className='w-full py-3'>
        <p className='text-sm sm:text-xl text-shadow-xs text-shadow-black'>Información de contacto</p>
      </div>
      ...
      <div className='w-full flex flex-col lg:flex-row py-2 '>
        <div className='flex w-1/2 items-center '>
          <div className='flex justify-center  items-center sm:p-2'>
            <PhoneIcon />
          </div>
        ...
        <div className='flex w-1/2'>
          ...
          <div className='flex flex-col justify-center'>
            ...
            <span className='text-xs text-gray-700'>📍 Parque Muvdi</span>
          </div>
        </div>
