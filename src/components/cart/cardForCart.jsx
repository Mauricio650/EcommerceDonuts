...
export function CardForCart ({ url_img, name, price, id, quantity }) {
  ...
  return (
    <article data-id={id} className='overflow-hidden space-grotesk flex w-full h-[70px] md:h-[100px] justify-between items-center rounded shadow-md shadow-black/50 bg-white'>
