export function SloganAndTitle () {
  return (
    <article className='relative max-[400px]:top-40 top-50 sm:top-0  flex  flex-col h-full sm:justify-center items-start p-2 gap-2 '>
      <h2 className='text-4xl md:text-6xl lg:text-3xl xl:text-6xl  chewy-regular text-shadow-xs text-shadow-black text-[#FF71A4]'>La vida es mejor con una dona en la mano !!</h2>
