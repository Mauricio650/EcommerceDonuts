...
export function ContactUsHome () {
  return (
    <section className='bg-[#FCAAC8] w-full h-full p-2  ring-3 ring-white rounded-4xl shadow-2xl shadow-black/70'>
      <section className='relative w-full h-full bg-[#FECBDE] p-5 sm:p-20 rounded-4xl shadow-md shadow-black/20'>
        ...
        <section id='nosotros' className='w-full flex gap-3 flex-col md:flex-row mt-3'>
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d755.1963341453901!2d-74.77266829838516!3d10.927517039830631!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8ef5cdfc6ce004a3%3A0x8b3cb291c5be85b!2sParque%20Hip%C3%B3dromo!5e0!3m2!1ses-419!2sco!4v1758600094394!5m2!1ses-419!2sco" 
          width='100%' height='450'
            style={{ border: 0, borderRadius: '5px' }}
            allowFullScreen='' loading='lazy'
            referrerPolicy='no-referrer-when-downgrade'>
